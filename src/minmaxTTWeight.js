function run(Chess, chessInstance) {
	...
	for (i = 0; i < movesPlayerTurn1.length; i++) { //loop through players moves
		...
		console.log(movesOpponentTurn2.length)
		var scoresofOpponentMovesPlayerTurn2 = [];
			...
			for (j = 0; j < movesOpponentTurn2.length; j++) { 
				...
				//if (jthMove.start.turn == 2)		
				// if (jthMove.start.turn == 6 && jthMove.end.coordinate == 'f6' && jthMove.end.coordinate == 'f2'){
				// 	console.log('test')
				// 	//TEST
				// }
	...
	/* 				var boardOpponentTurn4 = new Chess(boardPlayerTurn3.export());
				...
				// if (movesOpponentTurn2LegalList.length == 0){
				// 	console.log('BEEFMAN')		
				// }

				console.log(movesPlayerTurn3PlayerD2LegalList.length)
				...
				// if (Number.isInteger(presentMovesScore + ttWeight*travelMovesScore) == false){
				// 	console.log('BEEFMAN')		
				// }
		...
		// if (movesOpponentTurn2.length == 0){
		// 	console.log('BEEFMAN')		
		// }
		//console.log(scoresofOpponentMovesPlayerTurn2)
		console.log(movesOpponentTurn2LegalList.length)
